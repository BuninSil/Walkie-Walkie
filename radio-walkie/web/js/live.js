...
const LIVE_JITTER = 0.12;  // запас на неровную доставку, с — минимальный (двоение убирает обрыв хвоста, а не буфер)
const LIVE_MAX_LAG = 0.45; // задержка выросла больше — пересинхронизация, чтобы не накапливалась
